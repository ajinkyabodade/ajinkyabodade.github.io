...
<div class="main" >
 <div class="logo">
       <div class="form-group" style="margin:30px;" align="right" >
...
<form action="tgfill2f.php" method="POST"  >
<div class="container">
...
$conn=new mysqli("mysql7002.site4now.net", "lciov9zq_admin","Yash@1997","lciov9zq_collegemanagement");
	$result = $conn->query("SELECT * FROM tgform where name='$name' and emailid='$emailid' ");
