...
<h3 align="center"><em><strong><span style="font-size: 36px"><span style="font-family: Georgia">Student T/G Form  <div class="form-group" style="margin:30px;" align="center" >
...
<form action="tgfill2p.php" method="POST"  >
<div class="container">
...
$branch=$_POST["branch"];
$year=$_POST["year"];
$conn=new mysqli("mysql7002.site4now.net", "lciov9zq_admin","Yash@1997","lciov9zq_collegemanagement");
	$result = $conn->query("SELECT * FROM tgform where name='$name' and branch='$branch' and year='$year' ");
...
<div class="form-group" style="margin:30px;" >
<tr><td>Date Of Birth</td>	<td><input class="form-control" type="text" name="dob" value="<?php echo "".$row['dob'];?>" ></td>
