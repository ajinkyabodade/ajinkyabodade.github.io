...
<head>
    ...
    <title>Notes | Ganesh Deshmukh</title>
    <!-- Bootstrap Core CSS -->
							...
							<div class="col-lg-12">
								<div class="w3-card-4 w3-white animated zoomIn" id="allnotes">
									<header class="w3-container w3-light-grey">
									  ...
									  <small>For GATE, SSC, Banking Exams, IT Drives, CAT, IAS and Government Exams etc.</small>
									</header>
									<div class="w3-container" >
									<?php 
										$sql1 = "select * from notes where cat = 'Engineering-Gate'";
										$q1 = $conn->query($sql1);
										for($i=0;$i<$q1->num_rows;$i++)
										{
											 $res1 = $q1->fetch_assoc();
											 ?>
											 <div class="row topic" style="margin:10px; cursor:pointer;" data-cat="Engineering-Gate" data-topic="<?php echo $res1['id']; ?>">
												<div class="col-1" style="text-align:center;">
													<?php echo $i+1 .'.'; ?>
												</div>
												<div class="col" >
													<?php echo $res1['topicname']; ?>
												</div>
											 </div>
											 <?php
										}
