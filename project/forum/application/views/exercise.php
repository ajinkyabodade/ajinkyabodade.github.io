...
<body ng-app="myApp" background="../../bg.jpg">
    <div class="container" style="margin-top: 12%;">
        ...
        <br>
        <center>
            <h1><b>Basic Discussion Forum In Codeigniter And AngularJs</b></h1>
        ...
        <div class="modal fade bs-modal-sm" id="myModal" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel" aria-hidden="true" >
            <div class="modal-dialog modal-sm" style="margin-left: 30%;">
                <div class="modal-content" style="width: 200%;">
                                  ...
                                  <fieldset>
                                    <div class="control-group">
                                        ...
                                        <div class="control-group" style="text-align:center">
                                            ...
                                            <div class="controls">
                                                <input class="btn btn-success" type="button" ng-click="login()" value="Login" style="padding-left: 50px;padding-right: 50px;">
                                            </div>
                                        </div>
                                        <br> {{message}}<hr><hr>
                               </form>
                               <ul id="myTab" class="nav nav-tabs" style="text-align: center;">
                                    ...
                                    <form class="form-horizontal" name="myForm2" ng-controller="registerCtrl" >
                                        ...
                                        <div class="control-group" style="text-align:center">
                                            ...
                                            <div class="controls">
                                                <input class="btn btn-success" type="button" ng-click="register()" value="Signup" style="padding-left: 50px; padding-right: 50px;">
                                            </div>
                                            <br>{{message}}
                                        </div>
                                    </fieldset>
                    ...
                    <div class="modal-footer" style="width: 200%; text-align:center; padding-left: 50px; padding-right: 50px;">
