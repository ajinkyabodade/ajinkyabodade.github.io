...
<head>
    ...
    <title>Received Emergency Events</title>
    <!-- Favicon-->
  ...
  <!-- Exportable Table -->
	...
	<script type="text/javascript">
          setInterval(function(){
                ...
                xmlhttp.open("GET","reeventsfetch.php",false);
                xmlhttp.send(null);
                document.getElementById("reeventsfetch").innerHTML=xmlhttp.responseText;
